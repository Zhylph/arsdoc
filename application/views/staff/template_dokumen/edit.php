...
<div class="p-4">
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
        <form method="POST" action="<?php echo site_url('staff/template_dokumen/edit/' . $template['id_template']); ?>" class="p-6">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="id_jenis" name="id_jenis" required
                            ...
                            <?php foreach ($jenis_dokumen as $jenis): ?>
                                <option value="<?php echo $jenis['id_jenis']; ?>" <?php echo set_select('id_jenis', $jenis['id_jenis'], $template['id_jenis'] == $jenis['id_jenis']); ?>>
                    ...
                    <div>
                        ...
                        <select id="status" name="status" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="aktif" <?php echo set_select('status', 'aktif', $template['status'] == 'aktif'); ?>>Aktif</option>
                            <option value="nonaktif" <?php echo set_select('status', 'nonaktif', $template['status'] == 'nonaktif'); ?>>Nonaktif</option>
                        </select>
                ...
                <div class="mt-6">
                    ...
                    <input type="text" id="nama_template" name="nama_template" value="<?php echo set_value('nama_template', $template['nama_template']); ?>" required
                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="mt-6">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="Deskripsi template (opsional)"><?php echo set_value('deskripsi', $template['deskripsi']); ?></textarea>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="instruksi_upload" name="instruksi_upload" rows="4"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="Instruksi untuk pengguna saat mengupload dokumen"><?php echo set_value('instruksi_upload', $template['instruksi_upload']); ?></textarea>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="flex items-center">
                                <input id="file_<?php echo $ext; ?>" type="checkbox" name="tipe_file_diizinkan[]" value="<?php echo $ext; ?>"
                                       <?php echo set_checkbox('tipe_file_diizinkan[]', $ext, in_array($ext, $allowed_types)); ?>
            ...
            <div class="mb-8 border-t border-gray-200 dark:border-gray-600 pt-8">
                ...
                <div id="no-fields" class="text-center py-8 text-gray-500 dark:text-gray-400" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Update no fields display
    updateNoFieldsDisplay();
});
...
function addField(data = {}) {
    ...
    const fieldHtml = `
        <div class="field-item border border-gray-200 dark:border-gray-600 rounded-lg p-4 mb-4" data-field="${fieldCounter}">
            ...
            <input type="hidden" name="fields[${fieldCounter}][urutan]" value="${data.urutan || fieldCounter}">
            ${data.id_field ? `<input type="hidden" name="fields[${fieldCounter}][id_field]" value="${data.id_field}">` : ''}
        </div>
    `;
...
function updateNoFieldsDisplay() {
    const container = document.getElementById('fields-container');
    const noFields = document.getElementById('no-fields');
    noFields.style.display = container.children.length === 0 ? 'block' : 'none';
}
</script>
